...
<link href="css/style.css" rel='stylesheet' type='text/css' />
  ...
  <!-- End menu -->      
           ...
           <br>
           <br>
            <br><center style=" color: green;">COURSE DETAILS INSERTED SUCCESSFULLY</center>
           <br>
            <br>
           <br>
       ...
       NO.OF SEATS  :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   <input type="text" name="noofseats" placeholder="NO.OF SEATS"><br> <br>
            <br>
            BC RESERVATION  :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   <input type="text" name="bcreservstion" placeholder="BC RESERVATION"><br> <br><br>
       SC RESERVATION  :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   <input type="text" name="screservation" placeholder="SC RESERVATION"><br> <br>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  <input type="submit" value="ADD COURSE DETAILS" style="color: green; size: 50px;">
