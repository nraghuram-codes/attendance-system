...
<%@page import="java.sql.ResultSet" %>
  ...
  <body style="background-color:#eae3e4;">
    <!-- <a class="scrollToTop" href="#">
      <i class="fa fa-angle-up"></i>      
    </a> -->
  <!-- END SCROLL TOP BUTTON -->
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="mu-our-teacher-area">
            <!-- begain title -->
          <div class="mu-title">
              <h3 style="margin-left:15px;">LOW-LEVEL ATTENDANCE STUDENTS DETAILS</h3>
...
<br>
 ...
 <style type="text/css">
           ...
           td{
            ...
            background-color: rgba(31, 245, 207, 0.3);
           width: 400px;
           height: 30px;
...
<tr><th>STUDENT NAME</th><th>BRANCH</th><th>YEAR</th><th>SEMISTER</th><th>USERID</th><th>MONTH</th><th>PRESENTS</th><th>WORKINGDAYS</th><th>PERCENTAGE</th><th>PERFORMANCE</th></tr>
...
PreparedStatement ps1=connection.prepareStatement("select studentname,branch,year,semister,userid,month,presents,workingdays,percentage,performance from collegesystem.attendence where performance='BAD'");
rs=ps1.executeQuery();
...
<td><%=accno %></td><td><%=amount %></td><td><%=pincode %></td><td><%=address %></td><td><%=city %></td><td><%=state %></td></tr>
