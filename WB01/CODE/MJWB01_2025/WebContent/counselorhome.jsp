    ...
    <nav class="navbar navbar-default" role="navigation">  
      <div class="container">
        <div class="navbar-header">
          ...
          <!-- LOGO -->              
          <!-- TEXT BASED LOGO -->
          <a class="navbar-brand" href="index.html"><i class="fa fa-university"></i><span>Counselor </span></a>
          <!-- IMG BASED LOGO  -->
          ...
          <ul id="top-menu" class="nav navbar-nav navbar-right main-nav">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu" role="menu">
                   <li><a href="studentapplicationdetailsviewcounselor.jsp"> Students Application Details</a></li>  
                            
                <li><a href="allselectedstudentscounselorview.jsp">Selected Students</a></li> 
                   <li><a href="viewcoursedetails.jsp">View Seats</a></li>    
                 <li><a href="viewhallticketofallstudents.jsp">View Halltickets</a></li>
             ...
             <li class="dropdown">
              ...
              <ul class="dropdown-menu" role="menu">
                ...
                <li><a href="view-jntu-clgscounselor.jsp">View Jntu Colleges</a></li>   
                 ...
                 <li><a href="counselorhome.jsp">Logout</a></li> 
