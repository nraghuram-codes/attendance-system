...
<link href="css/style.css" rel='stylesheet' type='text/css' />
  ...
  <!-- End menu -->      
           ...
           <marquee style=" color: red; size: 50px;"> <h1>Admin  Added Faculty Details successfully</h1></marquee>
           <br>
           <br>
            <br>
           <br>
            <br>
             <br><form action="AdminAddFacultyDetails" method="post" >	
	<h1>  Admin  Add Faculty Details </h1>
    ...
    border-top-left-radius: 30px;
           ...
           <tr><th>UNIVERSITY NAME</th><td><input type="text" name="universityname" placeholder="UNIVERSITY NAME"></td></tr>
            ...
            <tr><th>  NAME OF FACULTY</th><td> <input type="text" name="nameoffaculty" placeholder="NAME OF FACULTY"></td></tr>
            <tr><th> EDUCATIONAL QUALIFICATION</th><td> <input type="text" name="educationalqualification" placeholder=" EDUCATIONAL QUALIFICATION"></td></tr>
              <tr><th>DESIGNATION</th><td><input type="text" name="designation" placeholder="DESIGNATION"></td></tr>
