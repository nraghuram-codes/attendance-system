...
<link href="css/style.css" rel='stylesheet' type='text/css' />
            ...
            <li class="dropdown">
             ...
             <li class="dropdown">
              ...
              <ul class="dropdown-menu" role="menu">
                ...
                <li><a href="view_clg_added_details.jsp">View College</a></li>   
  ...
  <!-- End menu -->      
           ...
           <marquee style=" color: red; size: 50px;"> <h1>Admin  Added jntu placement Details successfully</h1></marquee>
           <br>
           <br>
            <br>
           <br>
            <br>
             <br><form action="AdminAddJntuPlacementDetails" method="post" >	
	<h1>  Admin  Add placement  Details </h1>
    ...
    border-top-left-radius: 30px;
           ...
           <tr><th>UNIVERSITY NAME</th><td><input type="text" name="universityname" placeholder="UNIVERSITY NAME"></td></tr>
           
            <tr><th>COLLEGE NAME</th><td><input type="text" name="collegename" placeholder="COLLEGE NAME"></td></tr>
           
            <tr><th>BRANCH NAME  </th><td> <input type="text" name="branchname" placeholder="BRANCH NAME"></td></tr>
            <tr><th> TOTAL NO.OF STUDENTS PASSED OUT(IN LAST 2 YEARS)</th><td> <input type="text" name="students_passedout" placeholder=" NO.OF STUDENTS PASSED OUT"></td></tr>
              <tr><th>TOTAL NO.OF STUDENTS PLACED THROUGH PLACEMENT CELL(IN LAST 2 YEARS)</th><td><input type="text" name="students_placed" placeholder="NO.OF STUDENTS PLACED"></td></tr>
            
              <tr><th>COMPANY NAME</th><td><input type="text" name="companyname" placeholder="COMPANY NAME"></td></tr>
               <tr><th>SALARY PACKAGE</th><td><input type="text" name="salpackage" placeholder="PACKAGE"></td></tr>
            <tr><th>LOCATION</th><td><input type="text" name="location" placeholder="LOCATION"></td></tr>
           
           </table>
           
           
      
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  <input type="submit" value="ADD FACULTY DETAILS" style="color: green; size: 50px;">
