...
PreparedStatement ps1=connection.prepareStatement("select sno,stname,mobileno,selectcollegesnames,bank,accno,amount,pincode,address,city,state,country,accept from collegesystem.studentpaymnet where accept='waiting'");
rs=ps1.executeQuery();
