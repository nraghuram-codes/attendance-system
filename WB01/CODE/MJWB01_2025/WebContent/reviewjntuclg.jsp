...
%> --%><a href="#"><img src="Uploadimage/<%=filename%>" alt="img"></a>
               ...
               <form action="Jntuclgsrating" method="post"> 
 ...
 <input type="text" width="300" name="collegename" value="<%=collegename%>" placeholder="college name"><br><br>
 
 
 <%HttpSession sc=request.getSession();
 sc.setAttribute("collegename", collegename);
 
 System.out.println(" reviewjntuclg.jsp  --->collegename:"+collegename);
