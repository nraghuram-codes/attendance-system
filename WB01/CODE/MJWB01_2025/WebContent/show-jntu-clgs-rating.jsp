...
filename=(String)img.getAttribute("filename");
...
DBConnection con2=new DBConnection();
 ...
 //String sql1="SELECT COUNT(*) FROM collegesystem.srinivasaclgrating";//SELECT AVG(rating) FROM srinivasaclgrating
  ...
  String sql1="SELECT AVG(rating) FROM collegesystem.jntuclgrating";
                ...
                <aside class="mu-sidebar">
                  ...
                  <div class="mu-single-sidebar">
                    ...
                    <ul class="mu-sidebar-catg">
                      <li><a href="show-jntu-clgs-rating.jsp"><%=collegename1 %></a></li>    
                    </ul>
                  </div>
                  <!-- end single sidebar -->
                  <!-- start single sidebar -->
