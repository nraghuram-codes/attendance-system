...
String collegename=(String)ss.getAttribute("collegename");
/* ss.setAttribute("collegename", collegename); */
String imgname=ss.getAttribute("imgname").toString();

try 
{ 
Class.forName("com.mysql.jdbc.Driver");
Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/collegesystem","root","root");
String sql = "SELECT * FROM collegesystem.aupload where collegename='"+collegename+"' ";
...
<table><tr>
<b><%-- <% imgname=rs.getString(8); 
System.out.println("Image name"+imgname);
%> --%><%String city=rs.getString(2); %>
<siva1>COLLEGE NAME:&nbsp;&nbsp;&nbsp;<% collegename %><%=collegename %></siva1><br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<img style="width:250px;height:250px" src="Uploadimage/<%=imgname%>" alt="" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<br> <siva>LOCATION &nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%=city %></siva><br><br>
<siva>	RANK &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%String size=rs.getString(3); %><%=size %></siva><br><br>
	...
	<siva>STATE &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%String state=rs.getString(5); %><%=state%></siva><br><br>
...
String sql3 = "SELECT * FROM collegesystem.srinivasaclgrating ";
...
<img src="star-rating/my star.gif"></img>
<%} %>
...
DBConnection con2=new DBConnection();
 ...
 //String sql1="SELECT COUNT(*) FROM collegesystem.srinivasaclgrating";//SELECT AVG(rating) FROM srinivasaclgrating
  ...
  String sql1="SELECT AVG(rating) FROM collegesystem.srinivasaclgrating";
...
<%-- <table cellpadding="1" cellspacing="1" border="1" bordercolor="green"><td> <%="AVERAGE RATING:"+a %></td> 
 ...
 <h3> <a href="srinivasacollege.jsp" style="color: red;background-color: yellow; font: bold;">=>put review and rating</a></h3>   <br><br><br>                  
                ...
                <aside class="mu-sidebar">
                  ...
                  <div class="mu-single-sidebar">
                    ...
                    <ul class="mu-sidebar-catg">
                      <li><a href="srinivasacollege.jsp">SRINIVASA INSTITUTE OF SCIENCE AND TECHNOLOGY</a></li>    
                    </ul>
                  </div>
                  <!-- end single sidebar -->
                  <!-- start single sidebar -->
