      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
         ...
         <!--    <li><a href="user.jsp">Home</a></li> -->
            <li><a href="sitsfacultidetails.jsp">faculty details</a></li> 
            
                                 <li><a href="viewplacementdetailsadmin.jsp">View Placement Details</a></li> 
                                  <li><a href="sylabus.jsp">Syllabus</a></li>   
                                  <!--  <li><a href="showratingofsist.jsp?imgname=images.jpg&&collegename=SIRI%20INSTITUTE%20OF%20SCIENCE%20AND%20TECHNOLOGY">Courses</a></li> -->  
     ...
     <div class="row">
       <div class="col-md-12">
         <div class="mu-course-content-area">
           ...
           PreparedStatement ps1=connection.prepareStatement("select collegename,city,rank,university,state,country,filename from collegesystem.aupload where collegename='"+collegename+"'");
          rs=ps1.executeQuery();
...
%> --%><a href="#"><img src="Uploadimage/<%=filename%>" alt="img"></a>
 	 ...
 	 Connection connection1=con1.con();
/* HttpSession sc=request.getSession(false);
 collegename=(String)sc.getAttribute("collegename"); */

	
/* 	HttpSession img=request.getSession();
 collegename=(String)img.getAttribute("collegename");
	 */

	

	
//	img.getAttribute("imgname", imgname);
	
	



/* String sql3 = "SELECT * FROM collegesystem.jntuclgrating where collegename='"+srinivasa+"'"; */
String sql3 = "SELECT * FROM collegesystem.jntuclgrating where collegename='"+collegename+"'";

// where collegename='"+collegename+"'    //SELECT * FROM jntuclgrating WHERE collegename='srinivasa'
PreparedStatement ps2=(PreparedStatement)connection1.prepareStatement(sql3);
...
<% String nameee=rs3.getString(1);
String review=rs3.getString(2);
String rating=rs3.getString(3);
 collegename1=rs3.getString(4);
%>
Name :<%=nameee %><br></br>
Review :<%=review %><br><br>
Rating :

<%for(int k=1;k<=Integer.parseInt(rating);k++){ %>
<img src="star-rating/my star.gif" style="height: 20px; width: 30px;"></img>
<%} %>
...
DBConnection con2=new DBConnection();
 Connection connection2=con2.con();
 
 //String sql1="SELECT COUNT(*) FROM collegesystem.srinivasaclgrating";//SELECT AVG(rating) FROM srinivasaclgrating

 
  String sql1="SELECT AVG(rating) FROM collegesystem.jntuclgrating where collegename='"+collegename+"'";
 
 PreparedStatement ps3=connection2.prepareStatement(sql1);
...
%>
<table cellpadding="1" cellspacing="1" border="1" bordercolor="green"><td> <%="AVERAGE RATING:"+a %></td> 
         </table>
 ...
 <h3> <a href="reviewjntuclg.jsp?imgname=<%=filename%>&&collegename=<%=collegename %>" style="color: red;background-color: yellow; font: bold;">=>put review and rating</a></h3>   <br><br><br>                  
                        ...
                        <div class="mu-latest-course-single-content">
                          ...
                          <ul>
                            <li> <span>Course Price</span> <span>RS250000.00</span></li>
                            <li> <span>Place</span> <span>Andrapradesh,INDIA</span></li>
                  ...
                  <div class="mu-related-item-area">
                    <div id="mu-related-item-slide">
                      <div class="col-md-6">
                        <div class="mu-latest-course-single">
                          <figure class="mu-latest-course-img">
                            <a href="#"><img style="visibility: hidden;" alt="img" src="assets/img/courses/1.jpg"></a>
                            <figcaption class="mu-latest-course-imgcaption">
                              <a href="#">Drawing</a>
