    ...
    <nav class="navbar navbar-default" role="navigation">  
      <div class="container">
        <div class="navbar-header">
          ...
          <!-- LOGO -->              
          <!-- TEXT BASED LOGO -->
          <a class="navbar-brand" href="index.html"><i class="fa fa-university"></i><span></span></a>
          <!-- IMG BASED LOGO  -->
          <!-- <a class="navbar-brand" href="index.html"><img src="assets/img/logo.png" alt="logo"></a> -->
        </div>
        <div id="navbar" class="navbar-collapse collapse">
          <ul id="top-menu" class="nav navbar-nav navbar-right main-nav">
            <!-- <li><a href="Adminhome.jsp">#</a></li>  -->
...
<tr><th>SL.NO</th><th>NAME OF FACULTY</th><th>EDUCATIONAL QUALIFICATION</th><th>DESIGNATION</th><th>BRANCH</th><!-- <th>UNIVERSITY NAME</th> --></tr>
...
PreparedStatement ps1=connection.prepareStatement("select slno,nameoffaculty,educationalqualification,designation,branch,universityname from collegesystem.addfacultydetails");
rs=ps1.executeQuery();
...
<%while(rs.next()){
	...
	slno=rs.getString(1);
	nameoffaculty=rs.getString(2);
	educationalqualification=rs.getString(3);
...
<tr><td><%=slno %></td><td><%=nameoffaculty %></td><td><%=educationalqualification %></td><td><%=designation %></td><td><%=branch %></td><%-- <td><%=universityname %></td> --%></tr>
...
PreparedStatement ps2=connection1.prepareStatement("SELECT COUNT(*) FROM addfacultydetails WHERE designation='professor'");
rs=ps2.executeQuery();
...
<p style=" color: green; width: 20px; height: 10px;"> Nof  professors:<%=noofprofessors %></p>
