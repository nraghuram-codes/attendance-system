...
String subject=null;
String regno=null;
String yearofpass1=null;
String percentage1=null;
String ugreg=null;
String yearofpass2=null;
String percentage2=null;
String greg=null;
String yearofpass3=null;
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="mu-our-teacher-area">
            <!-- begain title -->
            <div class="mu-title">
              <h2>Students Application forms Details</h2>
...
<tr><th>SL.NO</th><th>STUDENT NAME</th><th>SUBJECT</th><th>10th REGNO</th><th>YEAR OF PASS</th><th>PERCENTAGE</th><th>UNDERGRADUATE REGNO</th><th>YEAR OF PASS</th><th>PERCENTAGE</th><th>COURSE</th></tr>
...
PreparedStatement ps1=connection.prepareStatement("select discipline,studentname,subject,regno,yearofpass1,percentage1,ugreg,yearofpass2,percentage2,course from applicationform");

//PreparedStatement ps1=connection.prepareStatement("select discipline,subject,regno,yearofpass1,percentage1,ugreg,yearofpass2,percentage2,greg,yearofpass3,percentage3,course,studentname from applicationform");
rs=ps1.executeQuery();
...
<%while(rs.next()){
	...
	yearofpass1=rs.getString(5);
	percentage1=rs.getString(6);
	ugreg=rs.getString(7);
	yearofpass2=rs.getString(8);
	
	percentage2=rs.getString(9);
...
<tr><td><%=discipline %></td><td><%=studentname %></td><td><%=subject %></td><td><%=regno %></td><td><%=yearofpass1 %></td><td><%=percentage1 %></td><td><%=ugreg %></td><td><%=yearofpass2 %></td><td><%=percentage2 %></td><td><%=course %></td></tr>
...
/* collegename=request.getParameter("collegename"); */
  HttpSession s1=request.getSession(false);
              String collegename1=(String)s1.getAttribute("collegename");

DBConnection db1=new DBConnection();
Connection connection1=db1.con();

PreparedStatement ps2=connection1.prepareStatement("SELECT COUNT(*) from applicationform ");
rs=ps2.executeQuery();
...
<%while(rs.next()){
	...
	noofprofessors=rs.getInt(1);
	
%>



<p style=" color: green; width: 20px; height: 10px;"> Nof  Students:<%=noofprofessors %></p>
        ...
        <br><br><br>                
           ...
           <%} %>
            ...
            <%PreparedStatement ps3=connection1.prepareStatement("SELECT COUNT(*) FROM addfacultydetails WHERE designation='ASSOSIATE  PROFESSOR'");
	...
	noofassociateprofessor1=rs2.getInt(1);
...
%>
          ...
          <%--   <p style=" color: green; width: 20px; height: 10px; padding-right: 300px;">Associate professors:<%=noofassociateprofessor1 %></p>  --%>
