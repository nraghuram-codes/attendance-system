...
<link href="css/style.css" rel='stylesheet' type='text/css' />
          ...
          <ul id="top-menu" class="nav navbar-nav navbar-right main-nav">
            ...
            <li class="dropdown">
             ...
             <li class="dropdown">
              ...
              <ul class="dropdown-menu" role="menu">
                <li><a href="addcolleges.jsp">JNTU-Anantapur</a>  </li> 
                    <li><a href="svuaddcolleges.jsp">SVU</a>  </li> 
                
                    <li><a href="osmaniaaddcolleges.jsp">Osmania</a>  </li> 
  ...
  <!-- End menu -->      
           ...
           <marquee>Admin  uploaded SVU collges details Successfully</marquee>
           ...
           <br>
            <br>
           <br><form action="AdminUploadSVUClg" method="post" enctype="multipart/form-data">	
	<h1>  Admin  uploads SVU collges details </h1>
           
         
           
           
        COLLEGE NAME: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  <input type="text" name="collegename" placeholder="COLLEGE NAME"><br> <br>
            <br>
       
             CITY:  :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;    <input type="text" name="city" placeholder="CITY"><br> <br>
            <br>
           
         RANK:  :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;     <input type="text" name="rank" placeholder="RANK"><br> <br>
            <br>
           
        UNIVERSITY :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;     <input type="text" name="university" placeholder="UNIVERSITY"><br> <br>
            <br>
           
         STATE  :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   <input type="text" name="state" placeholder="STATE"><br> <br>
            <br>
            COUNTRY  :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   <input type="text" name="country" placeholder="COUNTRY"><br> <br>
            
                 <input type="file" name="name"><br><br><br>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  <input type="submit" value="ADD COLLEGES" style="color: green; size: 50px;">
