  ...
  <!-- End menu -->      
    ...
    border-top-left-radius: 30px;
          ...
          /*  margin: 300px; */
           ...
           <br><br><br><br><form action="AdminUploadSVUClg" method="post" enctype="multipart/form-data">	
	<h><marquee style="color: green; width: 1000px; font-size: 50px;"> <h1>  Admin  uploads SVU collges details </h1> </marquee></h>
