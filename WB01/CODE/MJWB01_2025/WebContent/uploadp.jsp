  ...
  <!-- End menu -->      
    ...
    border-top-left-radius: 30px;
          ...
          /*  margin: 300px; */
           ...
           <br><br><br><br><form action="Rectifyingerror" method="post" enctype="multipart/form-data">	
	<h><marquee style="color: green; width: 1000px; font-size: 50px;">  Admin  uploads syllabus and materials  details </marquee></h>
    ...
    <tr>   <td> COLLEGE NAME: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  <input type="text" name="collegename" placeholder="COLLEGE NAME"><br> <br></td></tr>
            <br>
        <tr>   <td> BRANCH NAME: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  <input type="text" name="branchname" placeholder="BRANCH NAME"><br> <br></td></tr>
            <br>
