...
<html lang="en">
  ...
  <section id="mu-menu">
    <nav class="navbar navbar-default" role="navigation">  
      ...
      <li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">Student Info <span class="fa fa-angle-down"></span></a>
              <ul class="dropdown-menu" role="menu">
              
              <%
              String atd="attendence";
    		 String intr="internal";
    		 String extr="external";
              %>
                          
                <li><a href="auserid.jsp?<%=atd%>">Attendance</a></li>   
                 <li><a href="auserid.jsp?<%=intr%>">Internal</a></li>     
                   <li><a href="auserid.jsp?<%=extr%>">External </a></li>           
              </ul>
            </li> 
    ...
    <div class="mu-footer-bottom">
      <div class="container">
        <div class="mu-footer-bottom-area">
          <p>&copy; All Right Reserved. Designed by <a href="http://www.markups.io/" rel="nofollow">Admin</a></p>
        </div>
      </div>
    </div>
    <!-- end footer bottom -->
