...
String bcreservation=null;
String screservation=null;
...
<tr><th>COLLEGE NAME</th><th>BRANCH</th><th>NO.OF SEATS</th><th>BC RESERVATION</th><th>SC RESERVATION</th></tr>
...
PreparedStatement ps1=connection.prepareStatement("select collegename,branch,noofseats,bcreservation,screservation from collegesystem.addcoursedetails");
rs=ps1.executeQuery();
...
<%while(rs.next()){
	 ...
	 branchname=rs.getString(2);
		...
		noofseats=rs.getString(3);
		bcreservation=rs.getString(4);
		screservation=rs.getString(5);
...
<tr><td><%=collegename %></td><td><%=branchname %></td><td><%=noofseats %></td><td><%=bcreservation %></td><td><%=screservation %></td></tr>
