      ...
      <div class="row">
        <div class="col-md-12">
          <div class="mu-our-teacher-area">
            <!-- begain title -->
            <div class="mu-title">
              <h2>Halltickets details and Colleges</h2>
...
PreparedStatement ps1=connection.prepareStatement("select sno,studentname,hallticketno,branchname,collegename,universityname from collegesystem.issuhalticket ");
rs=ps1.executeQuery();
