...
//select sno,universityname,collegename,branchname,students_passedout,students_placed,companyname,salpackage,location
...
String students_passedout=null;
String students_placed=null;
String companyname=null;
String salpackage=null;
...
<tr><th>SL.NO</th><!-- <th>COLLEGE NAME</th> --><th>BRANCH</th><th>NO.OF STUDENTS PASSED OUT</th><th>NO.OF STUDENTS PLACED</th><!-- <th>UNIVERSITY NAME</th> --><th>COMPANY NAME</th><th>SAL-PACK</th><th>LOCATION</th></tr>
...
PreparedStatement ps1=connection.prepareStatement("select sno,universityname,collegename,branchname,students_passedout,students_placed,companyname,salpackage,location from collegesystem.jntuplacementdetails");
rs=ps1.executeQuery();
...
<%while(rs.next()){
	 ...
	 sno=rs.getInt(1);
	universityname=rs.getString(2);
	 collegename=rs.getString(3);
	 branchname=rs.getString(4);
	
	students_passedout=rs.getString(5);
	 students_placed=rs.getString(6);
	companyname=rs.getString(7);
			salpackage=rs.getString(8);
...
<tr><td><%=sno %></td><%-- <td><%=collegename %></td> --%><td><%=branchname %></td><td><%=students_passedout %></td><td><%=students_placed %></td><%-- <td><%=universityname %></td> --%><td><%=companyname %></td><td><%=salpackage %></td><td><%=location %></td></td></tr>
...
PreparedStatement ps2=connection1.prepareStatement("SELECT COUNT(*) FROM collegesystem.jntuplacementdetails");
rs=ps2.executeQuery();
...
<p style=" color: green;
    ...
    font-size: x-large;
    font-weight: 900;"> NO OF PLACEMENTS:<%=count %></p>
