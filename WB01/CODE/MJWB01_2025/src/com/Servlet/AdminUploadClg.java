...
/**
 * Servlet implementation class AdminUploadClg
 */
@WebServlet("/AdminUploadClg")
public class AdminUploadClg extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminUploadClg() {
        super();
	...
	*/
		...
		upbean.setPath(Uploadpath);
			...
			int status=	im.insertDetails(upbean);
