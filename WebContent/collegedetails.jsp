     ...
     <div class="row">
       <div class="col-md-12">
         <div class="mu-page-breadcrumb-area">
           ...
           <ol class="breadcrumb">
            <li><a href="#">Home</a></li>            
            <li class="active">college details</li>
          </ol>
         </div>
       </div>
     </div>
     ...
     <div class="row">
       <div class="col-md-12">
         <div class="mu-course-content-area">
           ...
           <%-- <tr><td><%=rs1.getString(1) %></td><td><%=rs1.getString(2) %></td><td><%=rs1.getString(3) %></td><td><%=rs1.getString(4) %></td><td><%=rs1.getString(5) %></td><td><a href="Authorfiles/<%=rs1.getString(6) %>" download><%=rs1.getString(6) %></a></td><td><%=rs1.getString(7) %></td><td><%=rs1.getString(8) %> --%>
                      ...
                      <div class="col-md-6">
                        <div class="mu-latest-course-single">
                          <figure class="mu-latest-course-img">
                            ...
                            <figcaption class="mu-latest-course-imgcaption">
                              <li><a href="">SWETHA INSTITUTE OF TECHNOLOGY AND SCIENCE</a></li>
                          ...
                          <div class="mu-latest-course-single-content">
                            ...
                            <div class="mu-latest-course-single-contbottom">
                              ...
                              <span href="#" class="mu-course-price">Rs250000.00</span>
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="mu-latest-course-single">
                          <figure class="mu-latest-course-img">
                            ...
                            <figcaption class="mu-latest-course-imgcaption">
                            <li><a href="">NARAYANADRI INSTITUTE OF SCIENCE AND TECHNOLOGY</a></li>
                              <span><i class="fa fa-clock-o"></i>4 years</span>
                            </figcaption>
                          </figure>
                          <div class="mu-latest-course-single-content">
                            ...
                            <div class="mu-latest-course-single-contbottom">
                              <a href="#" class="mu-course-details">Details</a>
                              <span href="#" class="mu-course-price">Rs300000.00</span>
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="mu-latest-course-single">
                          <figure class="mu-latest-course-img">
                            ...
                            <figcaption class="mu-latest-course-imgcaption">
                  <!--           <a href="showratingofsist.jsp">SRINIVASA INSTITUTE OF SCIENCE AND TECHNOLOGY</a> -->
                            <a href="showratingofsist.jsp"><%=collegename  %></a>
                              <span><i class="fa fa-clock-o"></i>4 years</span>
                            </figcaption>
                          </figure>
                          <div class="mu-latest-course-single-content">
              ...
              <div class="col-md-3">
                ...
                <aside class="mu-sidebar">
                  ...
                  <div class="mu-single-sidebar">
                    <h3>COLLEGES NAMES</h3>
                    <ul class="mu-sidebar-catg"><br><br><br><br>
                      <li><a href="showratingofsist.jsp">SRINIVASA INSTITUTE OF SCIENCE AND TECHNOLOGY</a></li><br><br><br><br>
                      <li><a href="">SWETHA INSTITUTE OF TECHNOLOGY AND SCIENCE</a></li><br><br><br><br>
                      <li><a href="">NARAYANADRI INSTITUTE OF SCIENCE AND TECHNOLOGY</a></li>
