...
<br>
 ...
 <style type="text/css">
    ...
    border-top-left-radius: 30px;
        ...
        <form name="f1" method="post" action="Internals">   
              <table>   
                     
      <tr><td colspan="2">STUDENT NAME :</td><td><input type="text" name="sname1" value="<%=name%>"></td></tr>
      <tr><td colspan="2">USER-ID:</td><td><input type="text" name="hno" value="<%=uid%>"></td></tr>
      <tr><td colspan="2">BRANCH:</td><td><input type="text" name="brnch" value="<%=branch%>"></td>
     <!--  <td><select name="brnch">
      ...
      <tr><td colspan="2">YEAR :</td><td><input type="text" name="year" value="<%=year%>"></td>
      <!-- <td><select name="year">
      ...
      <tr><td colspan="2">SEMISTER :</td><td><input type="text" name="semi" value="<%=smtr%>"></td>
      <!-- <td><select name="semi">
		        <option value="choose">choose</option>
...
<tr><td style="display:none;"></td></tr>
    ...
    <td><input type="text" name="a3" value="15" readonly="readonly"></td>
    <td><input type="text" name="a4" value="30" readonly="readonly"></td>
     <td><select name="res1">
     <option>PASS</option>
     <option>FAIL</option>
     </select></td> </tr> 
    ...
    <td><input type="text" name="b3" value="15" readonly="readonly"></td>
    <td><input type="text" name="b4" value="30" readonly="readonly"></td>
    <td><select name="res2">
     <option>PASS</option>
     <option>FAIL</option>
     </select></td> </tr> 
    ...
    <td><input type="text" name="c3" value="15" readonly="readonly"></td>
    <td><input type="text" name="c4" value="30" readonly="readonly"></td>
    <td><select name="res3">
     <option>PASS</option>
     <option>FAIL</option>
     </select></td> </tr> 
    ...
    <td><input type="text" name="d3" value="15" readonly="readonly"></td>
    <td><input type="text" name="d4" value="30" readonly="readonly"></td>
    <td><select name="res4">
     <option>PASS</option>
     <option>FAIL</option>
     </select></td> </tr> 
    ...
    <td><input type="text" name="e3" value="15" readonly="readonly"></td>
    <td><input type="text" name="e4" value="30" readonly="readonly"></td>
    <td><select name="res5">
     <option>PASS</option>
     <option>FAIL</option>
     </select></td> </tr> 
    ...
    <td><input type="text" name="comptr"></td>
    <td><input type="text" name="f3" value="15" readonly="readonly"></td>
    <td><input type="text" name="f4" value="30" readonly="readonly">
    </td> <td><select name="res6">
     <option>PASS</option>
     <option>FAIL</option>
     </select></td> </tr> 
