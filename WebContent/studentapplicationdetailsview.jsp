      ...
      <div class="row">
        <div class="col-md-12">
          <div class="mu-our-teacher-area">
            <!-- begain title -->
          <div class="mu-title">
              <h3 style="margin-left:15px;">STUDENTS EXTERNAL DETAILS</h3>
...
PreparedStatement ps1=connection.prepareStatement("select * from collegesystem.external");
rs=ps1.executeQuery();
...
<tr><th>StudentName</th><th>User-ID<th>Branch</th><th>Year</th>
        <th>Semister</th><th>English</th></tr>

	<tr><td><%=stname %></td><td><%=mobileno %></td><td><%=selectcollegesnames %></td><td><%=bank %></td>
	<td><%=accno %></td><td><%=amount %></td></tr>

    <tr>
        <th>Result</th><th>Maths-1</th><th>Result</th>
        <th>Maths-2</th><th>Result</th><th>Physics</th></tr>

    <tr><td><%=pincode %></td><td><%=address %></td>
	    <td><%=city %></td><td><%=state %></td><td><%=filename %></td><td><%=country %></td></tr>
	...
	<tr><td><%=selected %></td><td><%=collegenae %></td><td><%=branch %></td><td><%=nameoffaculty %></td>
        <td><%=designation %></td><td><%=universityname %></td><td><%=accept %></td><td><%=slno %></td></tr>
