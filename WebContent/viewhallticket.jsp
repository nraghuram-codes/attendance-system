              ...
              <ul class="dropdown-menu" role="menu">
                <li><a href="applicationformacadamicd.jsp">Registered Students Applicationform</a></li>                
                   <li><a href="paymentpaystudent.jsp">Payment</a></li>     
                    <li><a href="viewhallticket.jsp">ViewHallticketNo </a></li>    
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="mu-our-teacher-area">
            <!-- begain title -->
            <div class="mu-title">
              <h2>Allocated your college details</h2>
...
<tr><th>SL.NO</th><th>STUDENT NAME</th><th>HALLTICKET NO</th><th>BRACCH NAME</th><th> COLLEGE NAME </th><th> UNIVERSITY NAME </th></tr>
...
//String collegename=request.getParameter("collegename");
       ...
       /*      HttpSession session1=request.getSession(false);  */
              ...
              hallticketno=(String)session.getAttribute("hallticketno");
...
PreparedStatement ps1=connection.prepareStatement("select sno,studentname,hallticketno,branchname,collegename,universityname from collegesystem.issuhalticket where hallticketno='"+hallticketno+"'");
rs=ps1.executeQuery();
...
<tr><td><%=sno %></td><td><%=stname %></td><td><%=hallticketno %></td><td><%=branchname %></td><td><%=collegename %></td><td><%=universityname %></td></tr>
