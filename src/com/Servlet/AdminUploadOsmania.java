...
/**
 * Servlet implementation class AdminUploadOsmania
 */
@WebServlet("/AdminUploadOsmania")
public class AdminUploadOsmania extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminUploadOsmania() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String Uploadpath=realpath.substring(0,realpath.indexOf("."))+"University-Hub\\WebContent\\OsmaniaUploadimage\\";
		...
		upbean.setPath(Uploadpath);
			...
			int status=	im.insertosmania(upbean);
			...
			if(status==1)
			{
				...
				//AdminUploads.jsp
			response.sendRedirect("osmaniaaddcollegesSucces.jsp");	
			}
			else
			{
