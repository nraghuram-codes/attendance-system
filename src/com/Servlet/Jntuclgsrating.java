...
/**
 * Servlet implementation class Jntuclgsrating
 */
@WebServlet("/Jntuclgsrating")
public class Jntuclgsrating extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Jntuclgsrating() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("jntuclgsrating.java");
		// TODO Auto-generated method stub
		...
		try {
			...
			if(result==1){
				response.sendRedirect("show-jntu-clgs-rating.jsp");
				
				//?imgname=<%=filename%>&&collegename=<%=collegename %
